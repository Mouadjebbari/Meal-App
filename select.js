    ...
    .then((response) => response.json())
        ...
        for(let i in dataFilter){
            ...
            <div id="card" class="card mb-3" style="width: 20rem;">
                ...
                <img class="card-img-top" src=" ${dataFilter[i].strMealThumb}" class="card-img-top" alt="..."> >
                <div class="card-body">
                <h5 class="card-title">${dataFilter[i].strMeal}</h5>
                <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-light" onclick="showMealDetails(${dataFilter[i].idMeal})">Details</button>
                </div>
            </div>
            </div>
...
async function filterCategoryAndArea(CategorySelected, AreaSelected) {
    ...
    for (let i in meals) {
        ...
        <div class="cart col-sm-12 col-md-4 col-lg-4"  >
        <div id="card" class="card mb-3" style="width: 20rem;">
            <img class="card-img-top" src=" ${meals[i].strMealThumb}" class="card-img-top" alt="..." >
            <div class="card-body">
            <h5 class="card-title">${meals[i].strMeal}</h5>
            <div class="d-flex justify-content-between mt-5">
            <button type="button" class="btn btn-outline-light" onclick="showMealDetails(${meals[i].idMeal})">Details</button>
